 ...
 * @author avula
 */
public class CEFourthSemResultPage extends javax.swing.JFrame {

    /**
     * Creates new form CEFourthSemResultPage
     */
    public CEFourthSemResultPage() {
        initComponents();
    }
    public CEFourthSemResultPage(String rollNo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        fmhm_TextField = new javax.swing.JTextField();
        survey_TextField = new javax.swing.JTextField();
        ...
        getContentPane().add(bpd_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 220, 130, -1));

        jLabel11.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel11.setText("Survey Field Work - II");
        ...
        getContentPane().add(sm2_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 250, 130, -1));
        getContentPane().add(hhm_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 280, 130, -1));
        getContentPane().add(ct_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 310, 130, -1));
        getContentPane().add(sa1_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 340, 130, -1));
        getContentPane().add(te1_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 370, 130, -1));
        getContentPane().add(fmhm_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 400, 130, -1));
        getContentPane().add(survey_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 430, 130, -1));

        jLabel14.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel14.setText("Building Planning");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, -1, 20));

        jLabel15.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel15.setText("Strength of Materials - II");
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, -1, 20));

        jLabel16.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel16.setText("Hydraulics & Hydraulic ");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, -1, 20));

        jLabel17.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel17.setText("Concrete Technology");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, -1, 20));

        jLabel34.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel34.setText("Structural Analysis - I");
        getContentPane().add(jLabel34, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 340, -1, 20));

        jLabel42.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel42.setText("Transportation - I");
        getContentPane().add(jLabel42, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 160, 20));

        jLabel43.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel43.setText("FM & HM Lab");
        getContentPane().add(jLabel43, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, -1, 20));

        jLabel35.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/schoolPic2.png"))); // NOI18N
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select * from student inner join cefourthresult where student.rollNo='"+rollNo+"' and cefourthresult.rollNo='"+rollNo+"' and student.year='"+2+"' and cefourthresult.year='"+2+"' and student.semester='"+2+"' and cefourthresult.semester='"+2+"'");
            ...
            if(!rs.first()){
                ...
                bpd_TextField.setText(rs.getString(12));
                sm2_TextField.setText(rs.getString(13));
                hhm_TextField.setText(rs.getString(14));
                ct_TextField.setText(rs.getString(15));
                sa1_TextField.setText(rs.getString(16));
                te1_TextField.setText(rs.getString(17));
                fmhm_TextField.setText(rs.getString(18));
                survey_TextField.setText(rs.getString(19));
                ...
                bpd_TextField.setEditable(false);
                sm2_TextField.setEditable(false);
                hhm_TextField.setEditable(false);
                ct_TextField.setEditable(false);
                sa1_TextField.setEditable(false);
                te1_TextField.setEditable(false);
                fmhm_TextField.setEditable(false);
                survey_TextField.setEditable(false);
                total_TextField.setEditable(false);
                
                int bpd   = rs.getInt(12);
                int sm2 =rs.getInt(13);
                int hhm   = rs.getInt(14);
                int ct =rs.getInt(15);
                int sa1   = rs.getInt(16);
                int te1 =rs.getInt(17);
                int fmhm =rs.getInt(18);
                int survey =rs.getInt(19);
                
           
                
                
                if(bpd>=40 && sm2>=40 && hhm>=40 && survey >=40 && ct >=40 && sa1 >=40 && te1 >=40 && fmhm >=40){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CEFourthSemResultPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CEFourthSemResultPage().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField fmhm_TextField;
    ...
    private javax.swing.JTextField survey_TextField;
