 ...
 * @author avula
 */
public class CEseventhResult extends javax.swing.JFrame {

    /**
     * Creates new form CEseventhResult
     */
    public CEseventhResult() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(rs_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 232, 150, -1));
        ...
        getContentPane().add(submit_Button, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 430, -1, -1));
        ...
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(-100, -160, -1, -1));
    ...
    private void submit_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submit_ButtonActionPerformed
        ...
        int ee2 = Integer.parseInt(ee2_TextField.getText());
        int wre2 = Integer.parseInt(wre2_TextField.getText());
        int ge2 = Integer.parseInt(ge2_TextField.getText());
        int rs = Integer.parseInt(rs_TextField.getText());
        int git = Integer.parseInt(git_TextField.getText());
        int gwd = Integer.parseInt(gwd_TextField.getText());
        int gisLab = Integer.parseInt(gisLab_TextField1.getText());
        int iddLab = Integer.parseInt(iddLab_TextField.getText());
        int total = ee2+wre2+ge2+rs+git+gwd+gisLab+iddLab;

        try{
            Connection con = ConnectionProviderCode.getcon();
            Statement st = con.createStatement();
            st.executeUpdate("insert into ceseventhresult values("+ rollNo + ", " + 4 +", "+ 1 +", "+ ee2 +", "+ wre2+", "+ ge2 + ", " + rs+", "+ git+", "+ gwd+", "+ gisLab+", "+iddLab+", "+total+")" );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CEseventhResult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CEseventhResult().setVisible(true);
            }
        });
    }
