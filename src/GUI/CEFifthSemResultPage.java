 ...
 * @author avula
 */
public class CEFifthSemResultPage extends javax.swing.JFrame {

    /**
     * Creates new form CEFifthSemResultPage
     */
    public CEFifthSemResultPage() {
        initComponents();
    }
    public CEFifthSemResultPage(String rollNo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        te2_TextField = new javax.swing.JTextField();
        ctLab_TextField = new javax.swing.JTextField();
        geoLab_TextField = new javax.swing.JTextField();
        ...
        getContentPane().add(ms_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 220, 130, -1));
        ...
        getContentPane().add(eg_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 250, 130, -1));
        getContentPane().add(sa2_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 280, 130, -1));
        getContentPane().add(dd_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 310, 130, -1));
        getContentPane().add(te2_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 340, 130, -1));
        getContentPane().add(ctLab_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 370, 130, -1));
        getContentPane().add(geoLab_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 400, 130, -1));
        getContentPane().add(teLab_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 430, 130, -1));

        jLabel11.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel11.setText("Management Science");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, -1, 20));

        jLabel14.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel14.setText("Engineering Geology");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, -1, 20));

        jLabel15.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel15.setText("Structural Analysis -II");
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, -1, 20));

        jLabel16.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel16.setText("Design & Drawing");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, -1, 20));

        jLabel17.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel17.setText("Transportation - II");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 340, -1, 20));

        jLabel34.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel34.setText("Concrete Technology Lab");
        getContentPane().add(jLabel34, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, -1, 20));

        jLabel35.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel35.setText("Geology Lab");
        getContentPane().add(jLabel35, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, -1, 20));

        jLabel36.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel36.setText("Transportation Lab");
        ...
        getContentPane().add(jLabel37, new org.netbeans.lib.awtextra.AbsoluteConstraints(-140, -80, -1, -1));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select * from student inner join cefifthresult where student.rollNo='"+rollNo+"' and cefifthresult.rollNo='"+rollNo+"' and student.year='"+3+"' and cefifthresult.year='"+3+"' and student.semester='"+1+"' and cefifthresult.semester='"+1+"'");
            ...
            if(!rs.first()){
                ...
                ms_TextField.setText(rs.getString(12));
                eg_TextField.setText(rs.getString(13));
                sa2_TextField.setText(rs.getString(14));
                dd_TextField.setText(rs.getString(15));
                te2_TextField.setText(rs.getString(16));
                ctLab_TextField.setText(rs.getString(17));
                geoLab_TextField.setText(rs.getString(18));
                teLab_TextField.setText(rs.getString(19));
                ...
                ms_TextField.setEditable(false);
                eg_TextField.setEditable(false);
                sa2_TextField.setEditable(false);
                dd_TextField.setEditable(false);
                te2_TextField.setEditable(false);
                ctLab_TextField.setEditable(false);
                geoLab_TextField.setEditable(false);
                teLab_TextField.setEditable(false);
                total_TextField.setEditable(false);
                
                int ms   = rs.getInt(12);
                int eg =rs.getInt(13);
                int sa2   = rs.getInt(14);
                int dd =rs.getInt(15);
                int te2   = rs.getInt(16);
                int ctLab =rs.getInt(17);
                int geoLab =rs.getInt(18);
                int teLab =rs.getInt(19);
                
           
                
                
                if(ms>=40 && eg>=40 && sa2>=40 && dd >=40 && te2 >=40 && ctLab >=40 && geoLab >=40 && teLab >=40){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CEFifthSemResultPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CEFifthSemResultPage().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField geoLab_TextField;
    ...
    private javax.swing.JTextField te2_TextField;
