 ...
 * @author avula
 */
public class UpdateCEFifthSem extends javax.swing.JFrame {

    /**
     * Creates new form UpdateCEFifthSem
     */
    public UpdateCEFifthSem() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(te2_TextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 272, 150, -1));
        ...
        getContentPane().add(update_Button, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 430, -1, -1));
    ...
    private void search_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_search_ButtonActionPerformed
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM cefifthresult WHERE rollNo='"+rollNo+"'");
            ...
            if(!rs.first()){
                ...
                ms_TextField.setText(rs.getString(4));
                eg_TextField.setText(rs.getString(5));
                sa2_TextField.setText(rs.getString(6));
                dd_TextField.setText(rs.getString(7));
                te2_TextField.setText(rs.getString(8));
                ctLab_TextField.setText(rs.getString(9));
                geoLab_TextField1.setText(rs.getString(10));
                teLab_TextField.setText(rs.getString(11));
    ...
    private void update_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_ButtonActionPerformed
        // TODO add your handling code here:
        String rollNo = rollNo_TextField.getText();
        int msMarks = Integer.parseInt(ms_TextField.getText());
        int egMarks = Integer.parseInt(eg_TextField.getText());
        int sa2Marks = Integer.parseInt(sa2_TextField.getText());
        int ddMarks = Integer.parseInt(dd_TextField.getText());
        int te2Marks = Integer.parseInt(te2_TextField.getText());
        int ctLabMarks = Integer.parseInt(ctLab_TextField.getText());
        int geoLabMarks = Integer.parseInt(geoLab_TextField1.getText());
        int teLabMarks = Integer.parseInt(teLab_TextField.getText());
        int total = msMarks + egMarks + sa2Marks + ddMarks + te2Marks + ctLabMarks + geoLabMarks + teLabMarks;

        try{
            Connection con = ConnectionProviderCode.getcon();
            Statement st = con.createStatement();
            st.executeUpdate("UPDATE cefifthresult SET MS="+msMarks+", EG="+egMarks+", SA2="+sa2Marks+", DDRCS="+ddMarks+", TE2="+te2Marks+", CTLab="+ ctLabMarks+", geologyLab="+geoLabMarks+", TELab="+teLabMarks+", total="+total+" WHERE rollNo='"+rollNo+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateCEFifthSem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateCEFifthSem().setVisible(true);
            }
        });
    }
